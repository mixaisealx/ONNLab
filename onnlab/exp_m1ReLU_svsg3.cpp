...
void exp_m1ReLU_svsg3() {
	std::cout << "exp_m1ReLU_svsg3" << std::endl;

	const float M1_MAX_VALUE = 3.0f;
	...
	// Output m1ReLU layer 
	nn::NeuronHoldingStaticLayer<nn::NNB_m1ReLU> layer_m1out(11, [&](nn::NNB_m1ReLU *const mem_ptr, unsigned) {
	...
	nn::utils::Monotonic2FeildsProjectingAccessory projector_rl_m1(&layer_m1out, &layer_rleq, projector_2to1, projector_1to2);
	...
	*/
	...
	nn::FwdBackPropGuider learnguider_m1({ &layer_inp, &layer_m1out }, &nerr_setter);
