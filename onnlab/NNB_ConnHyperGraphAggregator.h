...
namespace nn
{
	...
	class NNB_ConnHyperGraphAggregator {
		std::vector<interfaces::ConnectionBasicInterface *> connections;

	public:
		NNB_ConnHyperGraphAggregator() {};

		NNB_ConnHyperGraphAggregator(std::initializer_list<interfaces::ConnectionBasicInterface *> connections):connections(connections) {
		};
