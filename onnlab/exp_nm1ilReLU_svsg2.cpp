...
void exp_nm1ilReLU_svsg2() {
	std::cout << "exp_nm1ilReLU_svsg2" << std::endl;
	...
	*/
	...
	std::ofstream log_loss("exp_nm1ilReLU_svsg2_loss.txt");

	bool stand_learn = true;

	float loss;
	for (size_t iterations = 0; iterations < 3500; ++iterations) {
		// Select datarow
