...
void exp_ReLU_CWL2_svsg() {
	std::cout << "exp_ReLU_CWL2_svsg" << std::endl;
	...
	nn::LearnGuiderFwBPg inferguider({ &layer_inp, &layer_relu1, &layer_out }, ATTACK_BATCH_SIZE);
...

	{
		...
		nn::reverse::CarliniWagnerL2 cwl2(inferguider, cwl2params, ATTACK_BATCH_SIZE);
	...
	{
		std::cout << "========\n";
		std::cout << "Running Multi-Thread CWL2...\n";
		...
		nn::reverse::CarliniWagnerL2ThreadAble cwl2(inferguider_thr, cwl2params, ATTACK_BATCH_SIZE, THREADS_COUNT);
