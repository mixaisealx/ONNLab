...
void exp_nm1ilReLU_ReLU_mnist_cmp2() {
	std::cout << "exp_nm1ilReLU_ReLU_mnist_cmp2" << std::endl;
	...
	auto Trainer_nmiReLU = [&]() {
		...
		while (true) {
			...
			std::ofstream log("exp_nm1ilReLU_ReLU_mnist_cmp1_nmiReLU_noH.log", std::ios::app);
