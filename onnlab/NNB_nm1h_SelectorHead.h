...
namespace nn
{
	...
	class NNB_nm1h_SelectorHead : public interfaces::NeuronBasicInterface, public interfaces::CustomBackPropogableInterface, public interfaces::BasicBackPropogableInterface {
		float single_output;
		...
		NNB_nm1h_SelectorHead(const NNB_nm1h_SelectorHead &) = delete;
		NNB_nm1h_SelectorHead &operator=(const NNB_nm1h_SelectorHead &) = delete;
	public:
		const bool is_standalone = standalone;

		NNB_nm1h_SelectorHead() {
			single_output = 0;
		...
		~NNB_nm1h_SelectorHead() override {
			for (auto inp : inputs) {
